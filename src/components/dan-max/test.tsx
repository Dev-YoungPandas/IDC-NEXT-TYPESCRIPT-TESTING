...
//
// CHANGES:
// - Replaced CTASection with SubscribeCTA
// - Removed GET_CAMILLA_PAGE_QUERY fetch (was only used for CTASection)
// - Removed unused imports: CTASection, GET_CAMILLA_PAGE_QUERY
// - SubscribeCTA data comes from GET_TESTIMONIALS_PAGE_QUERY
// ============================================
